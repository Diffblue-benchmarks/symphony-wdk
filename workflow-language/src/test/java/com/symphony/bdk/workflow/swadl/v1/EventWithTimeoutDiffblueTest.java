...
class EventWithTimeoutDiffblueTest {
  /**
   * Test {@link EventWithTimeout#equals(Object)}, and {@link EventWithTimeout#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean EventWithTimeout.equals(Object)", "int EventWithTimeout.hashCode()"})
  ...
  /**
   * Test {@link EventWithTimeout#equals(Object)}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void EventWithTimeout.<init>()", "String EventWithTimeout.getTimeout()",
      "void EventWithTimeout.setTimeout(String)", "String EventWithTimeout.toString()"})
  void testGettersAndSetters() {
    ...
    assertNull(actualEventWithTimeout.getActivityCompleted());
    assertNull(actualEventWithTimeout.getActivityExpired());
    assertNull(actualEventWithTimeout.getActivityFailed());
    assertNull(actualEventWithTimeout.getConnectionAccepted());
    assertNull(actualEventWithTimeout.getConnectionRequested());
    assertNull(actualEventWithTimeout.getFormReplied());
    assertNull(actualEventWithTimeout.getImCreated());
    assertNull(actualEventWithTimeout.getMessageReceived());
    assertNull(actualEventWithTimeout.getMessageSuppressed());
    assertNull(actualEventWithTimeout.getPostShared());
    assertNull(actualEventWithTimeout.getRequestReceived());
    assertNull(actualEventWithTimeout.getRoomCreated());
    assertNull(actualEventWithTimeout.getRoomDeactivated());
    assertNull(actualEventWithTimeout.getRoomMemberDemotedFromOwner());
    assertNull(actualEventWithTimeout.getRoomMemberPromotedToOwner());
    assertNull(actualEventWithTimeout.getRoomReactivated());
    assertNull(actualEventWithTimeout.getRoomUpdated());
    assertNull(actualEventWithTimeout.getTimerFired());
    assertNull(actualEventWithTimeout.getUserJoinedRoom());
    assertNull(actualEventWithTimeout.getUserLeftRoom());
    assertNull(actualEventWithTimeout.getUserRequestedJoinRoom());
    assertNull(actualEventWithTimeout.getAllOf());
    assertNull(actualEventWithTimeout.getOneOf());
  }
}
