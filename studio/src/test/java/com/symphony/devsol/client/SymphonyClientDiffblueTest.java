...
class SymphonyClientDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link UserV2} (default constructor) displayName {@code appId}.
  ...
  @Test
  @DisplayName(
      "Test getAppId(); given UserV2 (default constructor) displayName 'appId'; then content contentType 'application/json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.util.Map SymphonyClient.getAppId()"})
  void testGetAppId_givenUserV2DisplayNameAppId_thenContentContentTypeApplicationJson()
      throws Exception {
    // Arrange
    ...
    MockMvcBuilders.standaloneSetup(symphonyClient)
        ...
        .andExpect(content().string("{\"name\":\"appId\",\"appId\":\"${bdk.app.appId}\"}"));
  }
