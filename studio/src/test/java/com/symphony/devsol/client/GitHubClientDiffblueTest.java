...
class GitHubClientDiffblueTest {
  ...
  void testListGalleryCategories() throws RestClientException {
    ...
    gitHubTreeNode.setPath("categories//git/trees/main?recursive=1");
    ...
    when(restTemplate.getForObject(
            Mockito.<String>any(), Mockito.<Class<GitHubTree>>any(), isA(Object[].class)))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List GitHubClient.listGalleryWorkflows(String)"})
  void testListGalleryWorkflows_givenGitHubTreeNodePathIsGitTreesMainRecursive12()
      throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
   ...
   *
   * <ul>
   *   <li>Given {@link GitHubContent} (default constructor) Content is {@code 42}.
  ...
  @Test
  @DisplayName(
      "Test getWorkflow(String, String, String); given GitHubContent (default constructor) Content is '42'; then return replacement character")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String GitHubClient.getWorkflow(String, String, String)"})
  void testGetWorkflow_givenGitHubContentContentIs42_thenReturnReplacementCharacter()
      throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
    ...
    RestTemplate restTemplate = mock(RestTemplate.class);
    when(restTemplate.getForObject(
            Mockito.<String>any(), Mockito.<Class<GitHubContent>>any(), isA(Object[].class)))
   ...
   *
   * <ul>
   *   <li>Given {@link GitHubContent} (default constructor) Content is lf lf.
  ...
  @Test
  @DisplayName(
      "Test getWorkflow(String, String, String); given GitHubContent (default constructor) Content is lf lf; then return empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String GitHubClient.getWorkflow(String, String, String)"})
  void testGetWorkflow_givenGitHubContentContentIsLfLf_thenReturnEmptyString()
      throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String GitHubClient.getWorkflow(String, String, String)"})
  void testGetWorkflow_thenReturnReplacementCharacterReplacementCharacterZ2()
      throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String GitHubClient.getReadme(String, String)"})
  void testGetReadmeWithCategoryWorkflow2() throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  @Test
  @DisplayName(
      "Test getReadme(String, String) with 'category', 'workflow'; given GitHubContent (default constructor) Content is lf")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String GitHubClient.getReadme(String, String)"})
  void testGetReadmeWithCategoryWorkflow_givenGitHubContentContentIsLf()
      throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  @Test
  @DisplayName(
      "Test getReadme(String, String) with 'category', 'workflow'; given GitHubContent (default constructor) Content is lf lf")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String GitHubClient.getReadme(String, String)"})
  void testGetReadmeWithCategoryWorkflow_givenGitHubContentContentIsLfLf()
      throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  @Test
  @DisplayName(
      "Test getReadme(String, String) with 'category', 'workflow'; then return replacement character")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String GitHubClient.getReadme(String, String)"})
  void testGetReadmeWithCategoryWorkflow_thenReturnReplacementCharacter()
      throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  @Test
  @DisplayName(
      "Test getReadme(String) with 'category'; given GitHubContent (default constructor) Content is lf lf; then return empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String GitHubClient.getReadme(String)"})
  void testGetReadmeWithCategory_givenGitHubContentContentIsLfLf_thenReturnEmptyString()
      throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String GitHubClient.getReadme(String)"})
  void testGetReadmeWithCategory_thenReturnReplacementCharacterReplacementCharacterZ2()
      throws RestClientException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
