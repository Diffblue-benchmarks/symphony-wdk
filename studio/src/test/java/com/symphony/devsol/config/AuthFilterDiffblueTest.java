...
class AuthFilterDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link AuthFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}
   */
  @Test
  @DisplayName("Test doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain); then throw ServletException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AuthFilter.doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)"})
  void testDoFilterInternal_thenThrowServletException()
      throws AuthInitializationException, ServletException, IOException {
    // Arrange
   ...
   *   <li>Then calls {@link ExtAppClient#validate(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AuthFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}
   */
  @Test
  @DisplayName("Test doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain); when FilterChain doFilter(ServletRequest, ServletResponse) does nothing; then calls validate(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AuthFilter.doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)"})
  void testDoFilterInternal_whenFilterChainDoFilterDoesNothing_thenCallsValidate()
      throws AuthInitializationException, ServletException, IOException {
    // Arrange
    UserClaim userClaim = new UserClaim();
    userClaim.setAvatarSmallUrl("https://example.org/example");
