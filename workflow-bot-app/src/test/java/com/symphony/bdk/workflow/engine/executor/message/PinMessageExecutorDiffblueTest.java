...
class PinMessageExecutorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link PinMessageExecutor#execute(ActivityExecutorContext)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link PinMessageExecutor#doOboWithCache(ActivityExecutorContext)}
   */
  @Test
