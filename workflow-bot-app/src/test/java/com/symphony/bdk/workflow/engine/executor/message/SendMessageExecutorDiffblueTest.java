...
class SendMessageExecutorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link SendMessageExecutor#execute(ActivityExecutorContext)}
   */
  @Test
   ...
   * Test {@link SendMessageExecutor#execute(ActivityExecutorContext)}.
   * <ul>
   *   <li>Given {@link IllegalArgumentException#IllegalArgumentException(String)} with {@code Sending message...}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SendMessageExecutor#execute(ActivityExecutorContext)}
   */
   ...
   *   <li>When {@link ActivityExecutorContext} {@link ActivityExecutorContext#getEvent()} return {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SendMessageExecutor#execute(ActivityExecutorContext)}
   */
   ...
   * <p>
   * Method under test: {@link SendMessageExecutor#doOboWithCache(ActivityExecutorContext)}
   */
  @Test
