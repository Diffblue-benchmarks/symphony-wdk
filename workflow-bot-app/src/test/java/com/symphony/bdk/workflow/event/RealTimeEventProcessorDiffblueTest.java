...
class RealTimeEventProcessorDiffblueTest {
  ...
  @MethodsUnderTest({"Class RealTimeEventProcessor.sourceType()"})
  void testSourceType() {
    ...
    // Arrange and Act
    Class<RequestReceivedEvent> actualSourceTypeResult = (new RequestReceivedEventProcessor(new RuntimeServiceImpl()))
        .sourceType();
