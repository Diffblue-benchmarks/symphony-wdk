...
class GetUserStreamsExecutorDiffblueTest {
   ...
   *   <li>Then calls {@link StreamService#listStreams(StreamFilter)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GetUserStreamsExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName("Test execute(ActivityExecutorContext); given StreamService listStreams(StreamFilter) return ArrayList(); then calls listStreams(StreamFilter)")
