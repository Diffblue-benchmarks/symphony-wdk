...
class WorkflowNodeTypeHelperDiffblueTest {
  ...
  @MethodsUnderTest({"String WorkflowNodeTypeHelper.toType(String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String WorkflowNodeTypeHelper.toGroup(String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String WorkflowNodeTypeHelper.toUpperUnderscore(String)"})
