...
class ExecutionParametersDiffblueTest {
  /**
   * Test {@link ExecutionParameters#equals(Object)}, and {@link ExecutionParameters#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean ExecutionParameters.equals(Object)", "int ExecutionParameters.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ExecutionParameters.<init>(Map, String)", "Map ExecutionParameters.getArguments()",
      "String ExecutionParameters.getToken()", "String ExecutionParameters.toString()"})
