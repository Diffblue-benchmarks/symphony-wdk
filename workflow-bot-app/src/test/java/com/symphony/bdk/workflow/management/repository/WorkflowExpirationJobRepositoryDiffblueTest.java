...
class WorkflowExpirationJobRepositoryDiffblueTest {
  /**
   ...
   * </ul>
   * <p>
   * Method under test: {@link WorkflowExpirationJobRepository#existsById(Object)}
   */
  @Test
  @DisplayName("Test existsById(Object); given BaseJpaRepositoryImpl existsById(Object) return 'false'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean WorkflowExpirationJobRepository.existsById(Object)"})
  void testExistsById_givenBaseJpaRepositoryImplExistsByIdReturnFalse() {
    ...
    // Arrange
    BaseJpaRepositoryImpl<WorkflowExpirationJob, String> baseJpaRepositoryImpl = mock(BaseJpaRepositoryImpl.class);
