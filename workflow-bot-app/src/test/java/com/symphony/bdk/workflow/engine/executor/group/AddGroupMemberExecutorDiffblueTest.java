...
class AddGroupMemberExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link AddGroupMember} (default constructor).</li>
   *   <li>Then calls {@link ActivityExecutorContext#getActivity()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AddGroupMemberExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName("Test execute(ActivityExecutorContext); given AddGroupMember (default constructor); then calls getActivity()")
