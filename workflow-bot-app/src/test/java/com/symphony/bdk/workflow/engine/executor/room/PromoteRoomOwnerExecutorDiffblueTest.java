...
class PromoteRoomOwnerExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link PromoteRoomOwner} (default constructor).</li>
   *   <li>Then calls {@link ActivityExecutorContext#getActivity()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PromoteRoomOwnerExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName("Test execute(ActivityExecutorContext); given PromoteRoomOwner (default constructor); then calls getActivity()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PromoteRoomOwnerExecutor.execute(ActivityExecutorContext)"})
  void testExecute_givenPromoteRoomOwner_thenCallsGetActivity() {
    // Arrange
