...
class SwadlValidatorDiffblueTest {
   ...
   * <ul>
   *   <li>When {@code 42}.</li>
   *   <li>Then throw {@link SwadlNotValidException}.</li>
   * </ul>
   * <p>
  ...
  @MethodsUnderTest({"void SwadlValidator.validateYaml(String)"})
  void testValidateYaml_when42_thenThrowSwadlNotValidException() throws ProcessingException, SwadlNotValidException {
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void SwadlValidator.validateYaml(String)"})
  void testValidateYaml_whenTilde_thenThrowSwadlNotValidException() throws ProcessingException, SwadlNotValidException {
    // Arrange, Act and Assert
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void SwadlValidator.validateYaml(String)"})
  void testValidateYaml_whenYaml_thenThrowSwadlNotValidException() throws ProcessingException, SwadlNotValidException {
    // Arrange, Act and Assert
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void SwadlValidator.validateYaml(String)"})
  void testValidateYaml_whenYes_thenThrowSwadlNotValidException() throws ProcessingException, SwadlNotValidException {
    // Arrange, Act and Assert
