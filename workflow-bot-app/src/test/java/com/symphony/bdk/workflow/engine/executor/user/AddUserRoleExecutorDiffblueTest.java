...
class AddUserRoleExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link AddUserRole} (default constructor).</li>
   *   <li>Then calls {@link ActivityExecutorContext#getActivity()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AddUserRoleExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName("Test execute(ActivityExecutorContext); given AddUserRole (default constructor); then calls getActivity()")
