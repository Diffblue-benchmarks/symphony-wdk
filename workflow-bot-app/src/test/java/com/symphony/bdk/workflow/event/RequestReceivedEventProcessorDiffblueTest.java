...
class RequestReceivedEventProcessorDiffblueTest {
  @Autowired private RequestReceivedEventProcessor requestReceivedEventProcessor;
   ...
   * {@code RequestReceivedEvent}, {@code Map}.
   *
   * <ul>
  ...
  @Test
  @DisplayName(
      "Test processEventSource(RequestReceivedEvent, Map) with 'RequestReceivedEvent', 'Map'; then HashMap() size is one")
