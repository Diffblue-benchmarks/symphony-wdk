...
class GetMessageExecutorDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link GetMessageExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName(
      "Test execute(ActivityExecutorContext); given MessageService getMessage(String) return V4Message (default constructor); then calls getMessage(String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void GetMessageExecutor.execute(ActivityExecutorContext)"})
