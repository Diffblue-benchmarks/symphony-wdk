...
class GetMessageExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link MessageService} {@link MessageService#getMessage(String)} return {@link V4Message} (default constructor).</li>
   *   <li>Then calls {@link MessageService#getMessage(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GetMessageExecutor#execute(ActivityExecutorContext)}
   */
  @Test
