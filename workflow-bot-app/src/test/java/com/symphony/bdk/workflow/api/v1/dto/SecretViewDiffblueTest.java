...
class SecretViewDiffblueTest {
  ...
  @MethodsUnderTest({"boolean SecretView.equals(Object)", "int SecretView.hashCode()"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual2() {
    // Arrange
    SecretView secretView = new SecretView("Key", "\u0001\u0003\u0001\u0003".toCharArray());
    SecretView secretView2 = new SecretView("Key", "\u0001\u0003\u0001\u0003".toCharArray());
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    // Act and Assert
    assertNotEquals(secretView, new SecretView("Key", "\u0001\u0003\u0001\u0003".toCharArray()));
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void SecretView.<init>()", "void SecretView.<init>(String, char[])", "String SecretView.getKey()",
      "char[] SecretView.getSecret()", "void SecretView.setKey(String)", "void SecretView.setSecret(char[])",
      "String SecretView.toString()"})
