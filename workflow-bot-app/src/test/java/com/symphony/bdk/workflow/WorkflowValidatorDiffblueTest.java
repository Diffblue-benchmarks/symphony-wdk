...
class WorkflowValidatorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@code 42}.</li>
   *   <li>When {@link BaseActivity} {@link BaseActivity#getId()} return
   * {@code 42}.</li>
   * </ul>
   * <p>
   * Method under test:
   ...
   */
  @Test
  @DisplayName("Test validateFirstActivity(BaseActivity, Event, String); given '42'; when BaseActivity getId() return '42'")
  void testValidateFirstActivity_given42_whenBaseActivityGetIdReturn42() {
    // Arrange
    ActivityCompletedEvent activityCompleted = new ActivityCompletedEvent();
    activityCompleted.setActivityId("42");
    activityCompleted.setId("42");
   ...
   * <ul>
   *   <li>Given {@link Activity} {@link Activity#getActivity()} return
