...
class JoinActivityNodeBuilderDiffblueTest {
  @Autowired private JoinActivityNodeBuilder joinActivityNodeBuilder;

  /**
   * Test {@link JoinActivityNodeBuilder#type()}.
   *
   * <p>Method under test: {@link JoinActivityNodeBuilder#type()}
   */
  @Test
  @DisplayName("Test type()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"WorkflowNodeType JoinActivityNodeBuilder.type()"})
  void testType() {
