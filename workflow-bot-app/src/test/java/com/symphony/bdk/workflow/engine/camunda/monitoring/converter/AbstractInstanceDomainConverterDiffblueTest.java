...
class AbstractInstanceDomainConverterDiffblueTest {
  ...
  /**
   * Test {@link AbstractInstanceDomainConverter#instanceCommonBuilder(HistoricProcessInstanceEntity)}.
   * <ul>
   *   <li>Given {@code ACTIVE}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AbstractInstanceDomainConverter#instanceCommonBuilder(HistoricProcessInstanceEntity)}
   */
  @Test
   ...
   */
  @Test
  @DisplayName("Test instanceCommonBuilder(HistoricProcessInstanceEntity); given 'MD'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "com.symphony.bdk.workflow.monitoring.repository.domain.WorkflowInstanceDomain.WorkflowInstanceDomainBuilder AbstractInstanceDomainConverter.instanceCommonBuilder(HistoricProcessInstanceEntity)"})
  void testInstanceCommonBuilder_givenMd() {
    // Arrange
    HistoricProcessInstanceEntity hisProcInstance = mock(HistoricProcessInstanceEntity.class);
    when(hisProcInstance.getDurationInMillis()).thenReturn(1L);
    when(hisProcInstance.getEndActivityId()).thenReturn("42");
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractInstanceDomainConverter#resolveStatus(String, String)}
   */
  @Test
   ...
   * Test {@link AbstractInstanceDomainConverter#resolveStatus(String, String)}.
   * <ul>
   *   <li>When {@code His Proc Instance State}.</li>
   ...
   */
  @Test
  @DisplayName("Test resolveStatus(String, String); when 'His Proc Instance State'; then return 'null'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String AbstractInstanceDomainConverter.resolveStatus(String, String)"})
