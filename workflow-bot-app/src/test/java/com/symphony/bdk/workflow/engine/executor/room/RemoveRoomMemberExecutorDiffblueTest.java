...
class RemoveRoomMemberExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link RemoveRoomMember} (default constructor).</li>
   *   <li>Then calls {@link ActivityExecutorContext#getActivity()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link RemoveRoomMemberExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName("Test execute(ActivityExecutorContext); given RemoveRoomMember (default constructor); then calls getActivity()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RemoveRoomMemberExecutor.execute(ActivityExecutorContext)"})
  void testExecute_givenRemoveRoomMember_thenCallsGetActivity() {
    // Arrange
