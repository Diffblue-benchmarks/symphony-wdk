...
class SharedDataDiffblueTest {
  ...
  /**
   * Test {@link SharedData#equals(Object)}, and {@link SharedData#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean SharedData.equals(Object)", "int SharedData.hashCode()"})
  ...
  /**
   * Test {@link SharedData#equals(Object)}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void SharedData.<init>()", "String SharedData.getId()", "Long SharedData.getLastUpdated()",
      "String SharedData.getNamespace()", "Map SharedData.getProperties()", "void SharedData.setId(String)",
      "void SharedData.setLastUpdated(Long)", "void SharedData.setNamespace(String)",
      "void SharedData.setProperties(Map)", "String SharedData.toString()"})
