...
class GlobalExceptionHandlerDiffblueTest {
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(DuplicateException)} with
   * {@code DuplicateException}.
   * <ul>
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(IllegalArgumentException)} with
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(InvalidActivityException)} with
   * {@code InvalidActivityException}.
   * <ul>
   *   <li>Then StatusCode return {@link HttpStatus}.</li>
   * </ul>
   * <p>
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(NotFoundException)} with
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(OptimisticLockException)} with
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(UnauthorizedException)} with
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(UnsupportedOperationException)}
