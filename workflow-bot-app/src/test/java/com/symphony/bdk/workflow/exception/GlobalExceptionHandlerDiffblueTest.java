...
class GlobalExceptionHandlerDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test handle(DuplicateException) with 'DuplicateException'; then StatusCode return HttpStatus")
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(IllegalArgumentException)} with {@code IllegalArgumentException}.
   * <ul>
   *   <li>Then StatusCode return {@link HttpStatus}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GlobalExceptionHandler#handle(IllegalArgumentException)}
   */
  @Test
  @DisplayName("Test handle(IllegalArgumentException) with 'IllegalArgumentException'; then StatusCode return HttpStatus")
  @Tag("MaintainedByDiffblue")
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(InvalidActivityException)} with {@code InvalidActivityException}.
   * <ul>
   *   <li>Then StatusCode return {@link HttpStatus}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GlobalExceptionHandler#handle(InvalidActivityException)}
   */
  @Test
  @DisplayName("Test handle(InvalidActivityException) with 'InvalidActivityException'; then StatusCode return HttpStatus")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test handle(NotFoundException) with 'NotFoundException'; then StatusCode return HttpStatus")
  @Tag("MaintainedByDiffblue")
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(OptimisticLockException)} with {@code OptimisticLockException}.
   * <ul>
   *   <li>Then StatusCode return {@link HttpStatus}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GlobalExceptionHandler#handle(OptimisticLockException)}
   */
  @Test
  @DisplayName("Test handle(OptimisticLockException) with 'OptimisticLockException'; then StatusCode return HttpStatus")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test handle(Throwable) with 'Throwable'; when Throwable(); then StatusCode return HttpStatus")
  @Tag("MaintainedByDiffblue")
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(UnauthorizedException)} with {@code UnauthorizedException}.
   * <ul>
   *   <li>Then StatusCode return {@link HttpStatus}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GlobalExceptionHandler#handle(UnauthorizedException)}
   */
  @Test
  @DisplayName("Test handle(UnauthorizedException) with 'UnauthorizedException'; then StatusCode return HttpStatus")
  @Tag("MaintainedByDiffblue")
  ...
  /**
   * Test {@link GlobalExceptionHandler#handle(UnsupportedOperationException)} with {@code UnsupportedOperationException}.
   * <ul>
   *   <li>Then StatusCode return {@link HttpStatus}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GlobalExceptionHandler#handle(UnsupportedOperationException)}
   */
  @Test
  @DisplayName("Test handle(UnsupportedOperationException) with 'UnsupportedOperationException'; then StatusCode return HttpStatus")
  @Tag("MaintainedByDiffblue")
