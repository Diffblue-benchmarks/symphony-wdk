...
class AbstractNodeBpmnBuilderDiffblueTest {
  ...
  /**
   * Method under test:
   * {@link AbstractNodeBpmnBuilder#connect(WorkflowNode, String, AbstractFlowNodeBuilder, BuildProcessContext)}
   */
  @Test
  void testConnect() {
  ...
  /**
   * Method under test:
   * {@link AbstractNodeBpmnBuilder#connectToExistingNode(String, AbstractFlowNodeBuilder)}
   */
  @Test
