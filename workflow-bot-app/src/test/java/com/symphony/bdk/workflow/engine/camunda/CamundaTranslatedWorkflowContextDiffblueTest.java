...
class CamundaTranslatedWorkflowContextDiffblueTest {
  /**
   * Test {@link CamundaTranslatedWorkflowContext#equals(Object)}, and {@link CamundaTranslatedWorkflowContext#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean CamundaTranslatedWorkflowContext.equals(Object)",
      "int CamundaTranslatedWorkflowContext.hashCode()"})
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link CamundaTranslatedWorkflowContext#CamundaTranslatedWorkflowContext(Workflow, WorkflowDirectedGraph, BpmnModelInstance)}
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CamundaTranslatedWorkflowContext.<init>(Workflow, WorkflowDirectedGraph, BpmnModelInstance)",
      "BpmnModelInstance CamundaTranslatedWorkflowContext.getBpmnModelInstance()"})
