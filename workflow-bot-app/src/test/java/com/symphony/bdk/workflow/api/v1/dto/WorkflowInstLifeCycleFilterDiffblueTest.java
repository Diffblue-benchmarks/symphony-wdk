...
class WorkflowInstLifeCycleFilterDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link WorkflowInstLifeCycleFilter#WorkflowInstLifeCycleFilter(Instant, Instant, Instant, Instant)}
  ...
  @MethodsUnderTest({"void WorkflowInstLifeCycleFilter.<init>(Instant, Instant, Instant, Instant)",
      "Instant WorkflowInstLifeCycleFilter.getFinishedAfter()",
      "Instant WorkflowInstLifeCycleFilter.getFinishedBefore()",
      "Instant WorkflowInstLifeCycleFilter.getStartedAfter()",
      "Instant WorkflowInstLifeCycleFilter.getStartedBefore()"})
