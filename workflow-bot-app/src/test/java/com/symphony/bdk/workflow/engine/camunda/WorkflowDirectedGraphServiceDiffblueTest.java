...
class WorkflowDirectedGraphServiceDiffblueTest {
  ...
  /**
   * Test {@link WorkflowDirectedGraphService#getDirectedGraph(String, Long)} with
   * {@code id}, {@code version}.
   * <ul>
  ...
  /**
   * Test {@link WorkflowDirectedGraphService#getDirectedGraph(String)} with
   * {@code id}.
   * <ul>
   *   <li>Then return WorkflowId is {@code 42}.</li>
   * </ul>
