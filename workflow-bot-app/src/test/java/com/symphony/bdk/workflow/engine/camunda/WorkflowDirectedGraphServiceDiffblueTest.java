...
class WorkflowDirectedGraphServiceDiffblueTest {
  ...
  /**
   * Test {@link WorkflowDirectedGraphService#getDirectedGraph(String, Long)} with {@code id}, {@code version}.
   * <ul>
   *   <li>Then return WorkflowId is {@code 42}.</li>
   * </ul>
   * <p>
   * Method under test: {@link WorkflowDirectedGraphService#getDirectedGraph(String, Long)}
   */
  @Test
  @DisplayName("Test getDirectedGraph(String, Long) with 'id', 'version'; then return WorkflowId is '42'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"WorkflowDirectedGraph WorkflowDirectedGraphService.getDirectedGraph(String, Long)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link WorkflowDirectedGraphService#getDirectedGraph(String)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link WorkflowDirectedGraphService#putDirectedGraph(WorkflowDirectedGraph)}
   */
  @Test
  @DisplayName("Test putDirectedGraph(WorkflowDirectedGraph)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"WorkflowDirectedGraph WorkflowDirectedGraphService.putDirectedGraph(WorkflowDirectedGraph)"})
