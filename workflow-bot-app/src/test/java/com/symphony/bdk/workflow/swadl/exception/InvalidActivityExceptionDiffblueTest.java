...
class InvalidActivityExceptionDiffblueTest {
  @Autowired private InvalidActivityException invalidActivityException;

  /**
   * Test {@link InvalidActivityException#InvalidActivityException(String, String)}.
   *
   * <p>Method under test: {@link InvalidActivityException#InvalidActivityException(String, String)}
   */
  @Test
  ...
  void testNewInvalidActivityException() {
    // Arrange and Act
    InvalidActivityException actualInvalidActivityException =
        new InvalidActivityException("42", "An error occurred");
    ...
    assertEquals(
        "Invalid activity in the workflow 42: An error occurred",
        actualInvalidActivityException.getMessage());
