...
class CamundaBpmnBuilderDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "CamundaTranslatedWorkflowContext CamundaBpmnBuilder.translateWorkflow(Workflow)"
  })
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.camunda.bpm.engine.repository.Deployment CamundaBpmnBuilder.deployWorkflow(CamundaTranslatedWorkflowContext)"
  })
