...
class UniqueIdViolationExceptionDiffblueTest {
  ...
  @Autowired
  private UniqueIdViolationException uniqueIdViolationException;

  /**
   * Test {@link UniqueIdViolationException#UniqueIdViolationException(String, List)}.
   * <p>
   * Method under test: {@link UniqueIdViolationException#UniqueIdViolationException(String, List)}
   */
  @Test
  @DisplayName("Test new UniqueIdViolationException(String, List)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UniqueIdViolationException.<init>(String, List)"})
