...
class CreateSystemUserExecutorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link CreateSystemUserExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  ...
  @MethodsUnderTest({"void CreateSystemUserExecutor.execute(ActivityExecutorContext)"})
