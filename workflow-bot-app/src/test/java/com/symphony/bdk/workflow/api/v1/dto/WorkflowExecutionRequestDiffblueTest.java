...
class WorkflowExecutionRequestDiffblueTest {
  /**
   * Test {@link WorkflowExecutionRequest#equals(Object)}, and {@link WorkflowExecutionRequest#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean WorkflowExecutionRequest.equals(Object)", "int WorkflowExecutionRequest.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void WorkflowExecutionRequest.<init>()", "Map WorkflowExecutionRequest.getArgs()",
      "void WorkflowExecutionRequest.setArgs(Map)", "String WorkflowExecutionRequest.toString()"})
