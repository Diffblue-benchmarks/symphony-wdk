...
class ProcessingMessageToSwadlErrorDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "SwadlError ProcessingMessageToSwadlError.convert(JsonNode, YamlJsonPointer, ProcessingMessage)"
  })
  ...
  @Test
  @DisplayName(
      "Test convert(JsonNode, YamlJsonPointer, ProcessingMessage); given ArrayNode get(int) return valueOf ten; then return LineNumber is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "SwadlError ProcessingMessageToSwadlError.convert(JsonNode, YamlJsonPointer, ProcessingMessage)"
  })
  void testConvert_givenArrayNodeGetReturnValueOfTen_thenReturnLineNumberIsOne() {
    // Arrange
    DoubleNode yamlTree = DoubleNode.valueOf(10.0d);
  ...
  @Test
  @DisplayName(
      "Test convert(JsonNode, YamlJsonPointer, ProcessingMessage); given of one; when ProcessingMessage (default constructor); then return Message is '(no message)'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "SwadlError ProcessingMessageToSwadlError.convert(JsonNode, YamlJsonPointer, ProcessingMessage)"
  })
  void testConvert_givenOfOne_whenProcessingMessage_thenReturnMessageIsNoMessage() {
    // Arrange
    DoubleNode yamlTree = DoubleNode.valueOf(10.0d);
