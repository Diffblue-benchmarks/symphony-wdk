...
class WorkflowExpirationServiceDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link VersionedWorkflow} (default constructor) Active is {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link WorkflowExpirationService#scheduleWorkflowExpiration(String, Instant)}
   */
  @Test
  @DisplayName("Test scheduleWorkflowExpiration(String, Instant); given VersionedWorkflow (default constructor) Active is 'false'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void WorkflowExpirationService.scheduleWorkflowExpiration(String, Instant)"})
  void testScheduleWorkflowExpiration_givenVersionedWorkflowActiveIsFalse() {
    // Arrange
    when(workflowExpirationJobRepository.saveAll(Mockito.<Iterable<WorkflowExpirationJob>>any()))
    ...
    when(versionedWorkflowRepository.findByWorkflowId(Mockito.<String>any())).thenReturn(versionedWorkflowList);
    ...
    verify(workflowExpirationJobRepository).saveAll(isA(Iterable.class));
  }

  /**
   * Test {@link WorkflowExpirationService#scheduleWorkflowExpiration(String, Instant)}.
   * <ul>
   *   <li>Then calls {@link WorkflowExpirationPlanner#planExpiration(WorkflowExpirationJob)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link WorkflowExpirationService#scheduleWorkflowExpiration(String, Instant)}
   */
  @Test
  @DisplayName("Test scheduleWorkflowExpiration(String, Instant); then calls planExpiration(WorkflowExpirationJob)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void WorkflowExpirationService.scheduleWorkflowExpiration(String, Instant)"})
