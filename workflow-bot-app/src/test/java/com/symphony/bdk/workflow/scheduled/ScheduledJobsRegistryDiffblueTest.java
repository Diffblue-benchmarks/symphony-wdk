...
class ScheduledJobsRegistryDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@code 42}.
   *   <li>When {@link Id} {@link Id#id()} return {@code 42}.
   *   <li>Then calls {@link Id#id()}.
   * </ul>
   *
   * <p>Method under test: {@link ScheduledJobsRegistry#scheduleJob(RunnableScheduledJob)}
   */
  @Test
  @DisplayName(
      "Test scheduleJob(RunnableScheduledJob); given '42'; when Id id() return '42'; then calls id()")
