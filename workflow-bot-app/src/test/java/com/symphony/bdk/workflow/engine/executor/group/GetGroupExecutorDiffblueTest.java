...
class GetGroupExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link SymphonyGroupService} {@link SymphonyGroupService#getGroup(String)} return {@link ReadGroup} (default constructor).</li>
   *   <li>Then calls {@link SymphonyGroupService#getGroup(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GetGroupExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName("Test execute(ActivityExecutorContext); given SymphonyGroupService getGroup(String) return ReadGroup (default constructor); then calls getGroup(String)")
