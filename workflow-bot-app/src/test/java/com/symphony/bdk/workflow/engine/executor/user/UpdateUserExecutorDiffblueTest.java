...
class UpdateUserExecutorDiffblueTest {
  /**
   * Test {@link UpdateUserExecutor#execute(ActivityExecutorContext)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link UpdateUserExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void UpdateUserExecutor.execute(ActivityExecutorContext)"})
  void testExecute_givenKeysCurrentIsNull_thenCallsGetUserDetail() {
    ...
    // Arrange
    UpdateUserExecutor updateUserExecutor = new UpdateUserExecutor();
    ...
    ActivityExecutorContext<UpdateUser> context = mock(ActivityExecutorContext.class);
    ...
    // Act
    updateUserExecutor.execute(context);
  ...
  /**
   * Test {@link UpdateUserExecutor#doExecute(ActivityExecutorContext)}.
   *
   * <ul>
   *   <li>Given {@link CreateUser.Keys} (default constructor) Current is {@code null}.
   *   <li>Then calls {@link UserService#getUserDetail(Long)}.
   * </ul>
   *
   * <p>Method under test: {@link UpdateUserExecutor#doExecute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName(
      "Test doExecute(ActivityExecutorContext); given Keys (default constructor) Current is 'null'; then calls getUserDetail(Long)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void UpdateUserExecutor.doExecute(ActivityExecutorContext)"})
  void testDoExecute_givenKeysCurrentIsNull_thenCallsGetUserDetail() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
    ...
    // Act
    updateUserExecutor.doExecute(context);
  ...
  @Test
  @DisplayName(
      "Test doExecute(ActivityExecutorContext); given Keys (default constructor) Previous is 'null'; then calls getUserDetail(Long)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void UpdateUserExecutor.doExecute(ActivityExecutorContext)"})
  void testDoExecute_givenKeysPreviousIsNull_thenCallsGetUserDetail() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
