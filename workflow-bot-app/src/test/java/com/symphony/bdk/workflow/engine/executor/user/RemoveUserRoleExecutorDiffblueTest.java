...
class RemoveUserRoleExecutorDiffblueTest {
  @Autowired private RemoveUserRoleExecutor removeUserRoleExecutor;
   ...
   *
   * <ul>
   *   <li>Given {@link RemoveUserRole} (default constructor).
   *   <li>Then calls {@link ActivityExecutorContext#getActivity()}.
   * </ul>
   *
   * <p>Method under test: {@link RemoveUserRoleExecutor#execute(ActivityExecutorContext)}
  ...
  @Test
  @DisplayName(
      "Test execute(ActivityExecutorContext); given RemoveUserRole (default constructor); then calls getActivity()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void RemoveUserRoleExecutor.execute(ActivityExecutorContext)"})
