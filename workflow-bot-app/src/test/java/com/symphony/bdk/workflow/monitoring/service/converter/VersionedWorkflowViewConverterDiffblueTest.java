...
class VersionedWorkflowViewConverterDiffblueTest {
  ...
  /**
   * Test {@link VersionedWorkflowViewConverter#apply(VersionedWorkflow)} with {@code VersionedWorkflow}.
   * <p>
   * Method under test: {@link VersionedWorkflowViewConverter#apply(VersionedWorkflow)}
   */
  @Test
