...
class VersionedWorkflowViewConverterDiffblueTest {
  @Autowired private VersionedWorkflowViewConverter versionedWorkflowViewConverter;

  /**
   * Test {@link VersionedWorkflowViewConverter#apply(VersionedWorkflow)} with {@code
   * VersionedWorkflow}.
   *
   * <p>Method under test: {@link VersionedWorkflowViewConverter#apply(VersionedWorkflow)}
   */
  @Test
  @DisplayName("Test apply(VersionedWorkflow) with 'VersionedWorkflow'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"WorkflowView VersionedWorkflowViewConverter.apply(VersionedWorkflow)"})
