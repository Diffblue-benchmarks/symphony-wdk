...
class VersionedWorkflowConverterDiffblueTest {
  ...
  /**
   * Test {@link VersionedWorkflowConverter#apply(VersionedWorkflow)} with {@code VersionedWorkflow}.
   * <p>
   * Method under test: {@link VersionedWorkflowConverter#apply(VersionedWorkflow)}
   */
  @Test
