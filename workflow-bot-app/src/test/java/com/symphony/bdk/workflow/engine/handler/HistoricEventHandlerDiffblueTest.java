...
class HistoricEventHandlerDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link HistoryEvent} (default constructor) CaseDefinitionId is
   * {@code Case Definition Id}.</li>
   * </ul>
   * <p>
   ...
   * <ul>
   *   <li>Then calls
   * {@link HistoricEventActionExecutor#executeAction(HistoricEventAction, HistoryEvent)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link HistoricEventHandler#handleEvents(List)}
   */
