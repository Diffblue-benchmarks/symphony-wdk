...
class HistoricEventHandlerDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link HistoryEvent} (default constructor) CaseDefinitionId is {@code Case Definition Id}.</li>
   * </ul>
   * <p>
   * Method under test: {@link HistoricEventHandler#handleEvents(List)}
   */
  @Test
  @DisplayName("Test handleEvents(List); given HistoryEvent (default constructor) CaseDefinitionId is 'Case Definition Id'")
  @Tag("MaintainedByDiffblue")
   ...
   * Test {@link HistoricEventHandler#handleEvents(List)}.
   * <ul>
   *   <li>Then calls {@link HistoricEventActionExecutor#executeAction(HistoricEventAction, HistoryEvent)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link HistoricEventHandler#handleEvents(List)}
   */
  @Test
  @DisplayName("Test handleEvents(List); then calls executeAction(HistoricEventAction, HistoryEvent)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void HistoricEventHandler.handleEvents(List)"})
