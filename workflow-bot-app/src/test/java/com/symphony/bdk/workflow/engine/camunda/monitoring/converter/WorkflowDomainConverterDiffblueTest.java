...
class WorkflowDomainConverterDiffblueTest {
  ...
  /**
   * Test {@link WorkflowDomainConverter#apply(ProcessDefinitionEntity)} with {@code ProcessDefinitionEntity}.
   * <ul>
   *   <li>Then return Version is {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link WorkflowDomainConverter#apply(ProcessDefinitionEntity)}
   */
  @Test
