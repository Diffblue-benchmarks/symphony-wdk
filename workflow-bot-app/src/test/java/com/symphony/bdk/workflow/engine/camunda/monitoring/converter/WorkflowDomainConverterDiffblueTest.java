...
class WorkflowDomainConverterDiffblueTest {
  @Autowired private WorkflowDomainConverter workflowDomainConverter;

  /**
   * Test {@link WorkflowDomainConverter#apply(ProcessDefinitionEntity)} with {@code
   ...
   * </ul>
   *
   * <p>Method under test: {@link WorkflowDomainConverter#apply(ProcessDefinitionEntity)}
   */
  @Test
  @DisplayName(
      "Test apply(ProcessDefinitionEntity) with 'ProcessDefinitionEntity'; then return Version is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"WorkflowDomain WorkflowDomainConverter.apply(ProcessDefinitionEntity)"})
