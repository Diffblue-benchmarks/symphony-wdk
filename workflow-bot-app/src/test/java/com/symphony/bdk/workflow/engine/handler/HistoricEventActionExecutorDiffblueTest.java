...
class HistoricEventActionExecutorDiffblueTest {
  @Autowired private HistoricEventActionExecutor historicEventActionExecutor;

  /**
   * Test {@link HistoricEventActionExecutor#executeAction(HistoricEventAction, HistoryEvent)}.
   *
   * <p>Method under test: {@link HistoricEventActionExecutor#executeAction(HistoricEventAction,
   * HistoryEvent)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void HistoricEventActionExecutor.executeAction(HistoricEventAction, HistoryEvent)"
  })
