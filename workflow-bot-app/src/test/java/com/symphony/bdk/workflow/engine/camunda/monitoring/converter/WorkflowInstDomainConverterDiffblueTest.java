...
class WorkflowInstDomainConverterDiffblueTest {
  ...
  /**
   * Test {@link WorkflowInstDomainConverter#apply(HistoricProcessInstanceEntity)} with {@code HistoricProcessInstanceEntity}.
   * <ul>
   *   <li>Then return Version is {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link WorkflowInstDomainConverter#apply(HistoricProcessInstanceEntity)}
   */
  @Test
  @DisplayName("Test apply(HistoricProcessInstanceEntity) with 'HistoricProcessInstanceEntity'; then return Version is 'null'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"WorkflowInstanceDomain WorkflowInstDomainConverter.apply(HistoricProcessInstanceEntity)"})
