...
class VariableDomainConverterDiffblueTest {
  @Autowired private VariableDomainConverter variableDomainConverter;
   ...
   * </ul>
   *
   * <p>Method under test: {@link VariableDomainConverter#apply(HistoricDetail)}
   */
  @Test
  @DisplayName(
      "Test apply(HistoricDetail) with 'HistoricDetail'; given one; then return UpdateTime Nano is zero")
