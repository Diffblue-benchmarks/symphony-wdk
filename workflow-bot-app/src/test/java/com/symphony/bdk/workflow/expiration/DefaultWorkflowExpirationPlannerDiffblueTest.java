...
class DefaultWorkflowExpirationPlannerDiffblueTest {
   ...
   * <ul>
   *   <li>Then calls
   * {@link ScheduledJobsRegistry#scheduleJob(RunnableScheduledJob)}.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link DefaultWorkflowExpirationPlanner#planExpiration(WorkflowExpirationJob)}
   */
  @Test
  @DisplayName("Test planExpiration(WorkflowExpirationJob); then calls scheduleJob(RunnableScheduledJob)")
  void testPlanExpiration_thenCallsScheduleJob() {
