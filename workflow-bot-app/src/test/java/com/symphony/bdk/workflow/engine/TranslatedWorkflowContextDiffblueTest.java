...
class TranslatedWorkflowContextDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link TranslatedWorkflowContext#TranslatedWorkflowContext(Workflow, WorkflowDirectedGraph)}
  ...
  @MethodsUnderTest({"void TranslatedWorkflowContext.<init>(Workflow, WorkflowDirectedGraph)",
      "Workflow TranslatedWorkflowContext.getWorkflow()",
      "WorkflowDirectedGraph TranslatedWorkflowContext.getWorkflowDirectedGraph()"})
