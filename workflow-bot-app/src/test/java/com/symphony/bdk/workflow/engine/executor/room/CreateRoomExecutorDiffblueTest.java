...
class CreateRoomExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V3RoomDetail} (default constructor) roomSystemInfo {@link RoomSystemInfo} (default constructor).</li>
   *   <li>Then calls {@link StreamService#create(V3RoomAttributes)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CreateRoomExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName("Test execute(ActivityExecutorContext); given V3RoomDetail (default constructor) roomSystemInfo RoomSystemInfo (default constructor); then calls create(V3RoomAttributes)")
