...
class SpringBdkGatewayDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link BdkConfig} {@link BdkConfig#isCommonJwtEnabled()} return {@code false}.</li>
   * </ul>
   * <p>
  ...
  @MethodsUnderTest({"OboServices SpringBdkGateway.obo(AuthSession)"})
   ...
   * Test {@link SpringBdkGateway#obo(AuthSession)} with {@code oboSession}.
   * <ul>
   *   <li>Given {@link BdkConfig} {@link BdkConfig#isOboConfigured()} return {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SpringBdkGateway#obo(AuthSession)}
   */
   ...
   * Test {@link SpringBdkGateway#obo(AuthSession)} with {@code oboSession}.
   * <ul>
   *   <li>Given {@link BdkConfig} {@link BdkConfig#isOboConfigured()} throw {@link RuntimeException#RuntimeException(String)} with {@code /pod}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SpringBdkGateway#obo(AuthSession)}
   */
