...
class UpdateMessageExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link Template} {@link Template#process(Object)} return {@code <messageML>}.</li>
   *   <li>Then calls {@link MessageService#getMessage(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UpdateMessageExecutor#execute(ActivityExecutorContext)}
   */
  @Test
   ...
   * Test {@link UpdateMessageExecutor#execute(ActivityExecutorContext)}.
   * <ul>
   *   <li>Given {@link Template} {@link Template#process(Object)} return {@code Process}.</li>
   *   <li>Then calls {@link MessageService#getMessage(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UpdateMessageExecutor#execute(ActivityExecutorContext)}
