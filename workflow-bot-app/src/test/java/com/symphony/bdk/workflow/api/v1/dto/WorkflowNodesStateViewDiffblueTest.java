...
class WorkflowNodesStateViewDiffblueTest {
  /**
   * Test {@link WorkflowNodesStateView#equals(Object)}, and {@link WorkflowNodesStateView#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean WorkflowNodesStateView.equals(Object)", "int WorkflowNodesStateView.hashCode()"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void WorkflowNodesStateView.<init>()", "Map WorkflowNodesStateView.getError()",
      "VariableView WorkflowNodesStateView.getGlobalVariables()", "List WorkflowNodesStateView.getNodes()",
      "void WorkflowNodesStateView.setError(Map)", "void WorkflowNodesStateView.setGlobalVariables(VariableView)",
      "void WorkflowNodesStateView.setNodes(List)", "String WorkflowNodesStateView.toString()"})
