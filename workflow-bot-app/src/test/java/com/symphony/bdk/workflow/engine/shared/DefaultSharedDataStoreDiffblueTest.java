...
class DefaultSharedDataStoreDiffblueTest {
   ...
   * Test {@link DefaultSharedDataStore#getNamespaceData(String)}.
   * <ul>
   *   <li>Then calls {@link SharedData#getProperties()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DefaultSharedDataStore#getNamespaceData(String)}
   */
  @Test
  @DisplayName("Test getNamespaceData(String); then calls getProperties()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Map DefaultSharedDataStore.getNamespaceData(String)"})
  void testGetNamespaceData_thenCallsGetProperties() {
    // Arrange
    SharedData sharedData = new SharedData();
    sharedData.namespace("Namespace");
    sharedData.setId("42");
    ...
    when(sharedData2.getProperties()).thenReturn(new HashMap<>());
   ...
   * <p>
   * Method under test: {@link DefaultSharedDataStore#putNamespaceData(String, String, Object)}
   */
  @Test
   ...
   */
  @Test
  @DisplayName("Test putNamespaceData(String, String, Object); then calls getProperties()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DefaultSharedDataStore.putNamespaceData(String, String, Object)"})
  void testPutNamespaceData_thenCallsGetProperties() {
    // Arrange
    SharedData sharedData = new SharedData();
    sharedData.namespace("Namespace");
    sharedData.setId("42");
