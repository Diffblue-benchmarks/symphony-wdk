...
class ExecuteRequestExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link ExecuteRequest} {@link ExecuteRequest#isEncodeQueryParams()}
   ...
   * Test {@link ExecuteRequestExecutor#execute(ActivityExecutorContext)}.
   * <ul>
   *   <li>Given {@link HashMap#HashMap()} {@code U://U@[9U]:{UU?U#U} is {@code
   * 42}.</li>
   *   <li>Then calls {@link ExecuteRequest#setUrl(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link
   * ExecuteRequestExecutor#execute(ActivityExecutorContext)}
   */
  @Test
