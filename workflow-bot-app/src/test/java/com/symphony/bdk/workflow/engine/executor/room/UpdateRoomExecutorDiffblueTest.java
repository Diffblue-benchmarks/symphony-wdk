...
class UpdateRoomExecutorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link UpdateRoomExecutor#execute(ActivityExecutorContext)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link UpdateRoomExecutor#doOboWithCache(ActivityExecutorContext)}
   */
  @Test
