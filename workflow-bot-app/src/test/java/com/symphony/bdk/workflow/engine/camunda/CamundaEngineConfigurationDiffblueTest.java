...
class CamundaEngineConfigurationDiffblueTest {
  ...
  @MethodsUnderTest({
      "void com.symphony.bdk.workflow.engine.camunda.CamundaEngineConfiguration.preInit(org.camunda.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void com.symphony.bdk.workflow.engine.camunda.CamundaEngineConfiguration.postInit(org.camunda.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "org.springframework.boot.actuate.health.HealthIndicator com.symphony.bdk.workflow.engine.camunda.CamundaEngineConfiguration.processEngineHealthIndicator(org.camunda.bpm.engine.ProcessEngine)"})
