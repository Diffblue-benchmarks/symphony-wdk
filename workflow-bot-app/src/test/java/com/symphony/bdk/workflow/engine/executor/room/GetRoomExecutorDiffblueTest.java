...
class GetRoomExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link StreamService} {@link StreamService#getRoomInfo(String)} return {@link V3RoomDetail} (default constructor).</li>
   *   <li>Then calls {@link StreamService#getRoomInfo(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GetRoomExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName("Test execute(ActivityExecutorContext); given StreamService getRoomInfo(String) return V3RoomDetail (default constructor); then calls getRoomInfo(String)")
