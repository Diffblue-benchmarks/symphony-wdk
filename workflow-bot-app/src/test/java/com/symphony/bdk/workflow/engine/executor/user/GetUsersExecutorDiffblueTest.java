...
class GetUsersExecutorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link GetUsers} (default constructor).</li>
   ...
   */
  @Test
  @DisplayName("Test execute(ActivityExecutorContext); given GetUsers (default constructor); then calls getActivity()")
