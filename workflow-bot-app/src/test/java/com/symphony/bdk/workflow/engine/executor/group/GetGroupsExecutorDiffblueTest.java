...
class GetGroupsExecutorDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then calls {@link SymphonyGroupService#listGroups(Status, String, String, Integer,
   *       SortOrder)}.
   * </ul>
   *
   * <p>Method under test: {@link GetGroupsExecutor#execute(ActivityExecutorContext)}
   */
  @Test
  @DisplayName(
      "Test execute(ActivityExecutorContext); then calls listGroups(Status, String, String, Integer, SortOrder)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void GetGroupsExecutor.execute(ActivityExecutorContext)"})
  void testExecute_thenCallsListGroups() {
    ...
    // Assert
    verify(groupService).listGroups(null, null, null, 100, SortOrder.ASC);
